class SearchEngine:
    ...
    def search(self, keyword, k):
        """Cerca le k (un intero) pagine web con il massimo numero di occorrenze della keyword cercata. 
           ...
           per ognuna di queste k pagine, sono ordinate in ordine decrescente di occorrenze, la stringa del website del sito che hosta la pagina è aggiunta a s, a meno che il website non sia stato già inserito.  
        """
        pass
